...
# Tracer le graphique d'importance des variables (top 10)
...
# Variables pour lesquelles vous voulez générer des graphiques de dépendance partielle
variables_of_interest <- c("education", "applicant_income", "loan_amount", "credit_history")

# Paramètres de la grille pour les variables continues
...
# Configuration du dispositif graphique
par(mfrow = c(2, 2))

# Générer les graphiques de dépendance partielle
...
# Rétablir la configuration par défaut du dispositif graphique
par(mfrow = c(1, 1))
